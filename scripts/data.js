...
let levels = [
    ...
    */
    ...
    new Level("Oxidized", 105.75, 29, "Amethyst", "143289102", "Verification Route", ["XanderGMDD"], "zis08", "https://medal.tv/games/geometry-dash/clip/mY6abhPwQL6w1DYyC?invite=cr-MSxxVVosMTY4ODkwOTU4&v=35", [
        ...
        new Record("tFluffy", "1,667", "3/10", "either model amethyst or high plat", "https://youtu.be/aLW0O4jlll0"),
    ], false),
    ...
    */
    ...
    new Level("Clownparty", 75.11, 19, "Platinum", "146575586", "Small Skips", ["probro675"], "probro675", "https://www.youtube.com/embed/eFO4fpLLO9E?is=mtcfMEjlX61-kzV3", [
        ...
        new Record("ariopc", "1,030", "6/10", "it felt really gold tier but realistically i might have just improved, ill say like 75 pts for now just so it stays plat", "https://medal.tv/games/geometry-dash/clips/nufc62dWIDoNG725u?invite=cr-MSxLVkksMjE3MzQ4MzIz"),
    ], false),
    ...
    */
    ...
    new Level("The Adirondacks", 72.51, 13, "Gold", "148687922", "Small Skips", ["Taublix"], "Taublix", "https://www.youtube.com/embed/c1jlU7X56dk", [
        new Record("Taublix", "N/A", "9.5/10", "N/A", "https://www.youtube.com/watch?v=c1jlU7X56dk"),
    ], false),
    new Level("On The Cliffs edge", 72.39, 25, "Gold", "143825635", "Any Route", ["zis08", "windboss07"], "Tomatokatsup", "https://youtube.com/embed/usj8jDF53Qc", [
    ...
    new Level("Killbot Minus", 65.5, 8, "Gold", "142531440", "Small Skips", ["XanderGMDD"], "EndGamer7896", "https://medal.tv/games/geometry-dash/clip/nt3v5DPBz39XScyN9?invite=cr-MSxHTU8sNTk1MDYwNDc2", [
        new Record("EndGamer7896", "4,912", "2.5/10", "harder than AMD (submitted as 76 points)", "https://medal.tv/games/geometry-dash/clips/nt3v5DPBz39XScyN9?invite=cr-MSxHTU8sNTk1MDYwNDc2"),
        new Record("ariopc", "1,642", "0/10", "72", "https://medal.tv/games/geometry-dash/clips/nvXNA4nta1RwXLQQa?invite=cr-MSxGMDMsMjE3MzQ4MzIz"),
    ], "/nongs/Killbot, Killbot Minus.mp3"),
    ...
    new Level("Tiptoe Temple", 58.67, 12, "Gold", "96953991", "Smal Skips", ["iMintyGreen"], "Farlayy", "https://www.youtube.com/embed/xN16fwLFoAs", [
        new Record("Farlayy", "N/A", "N/A", "N/A", "https://www.youtube.com/watch?v=xN16fwLFoAs"),
        new Record("Taublix", "383", "doodoodoodoo/10", "49 points", "https://www.youtube.com/watch?v=hiSpQbS5A0A"),
    ], false),
    ...
    new Level("Robotic Uprising", 55.96, 13, "Gold", "148687914", "Small Skips", ["Taublix"], "Taublix", "https://www.youtube.com/embed/CMDBhIyTS5M", [
        new Record("Taublix", "N/A", "8.5/10", "N/A", "https://www.youtube.com/watch?v=CMDBhIyTS5M"),
    ], false),
    ...
    new Level("Jilsdfdlksdfjlsdfsdf", 54.74, 10, "Gold", "148780165", "Small Skips", ["sourceerrortxt"], "sourceerrortxt", "https://www.youtube.com/embed/tW1AKZYEvHo", [
        new Record("sourceerrortxt", "3,686", "5/10", "Anywhere from Mid-High Gold, doubt this is platinum", "https://www.youtube.com/watch?v=tW1AKZYEvHo"),
        new Record("ariopc", "534", "6/10", "low gold", "https://medal.tv/games/geometry-dash/clips/nvYNF75d5KdO9qxJ3?invite=cr-MSxRSzYsMjE3MzQ4MzIz"),
        new Record("Taublix", "279", "7.5/10", "42 points", "https://www.youtube.com/watch?v=dP75vHDdwh8t"),
    ], false),
    ...
    new Level("Leaper", 50.35, 5, "Gold", "141401606", "Any Route", ["EndGamer7896"], "EndGamer7896", "https://medal.tv/games/geometry-dash/clip/mNPdClIZVXD_8kwsC?invite=cr-MSwyaGMsNTk1MDYwNDc2", [
        ...
        new Record("tFluffy", "89", "6/10", "low-mid silver", "https://youtu.be/WLBJ4Rkkc2w"),
    ], false),
    ...
    */
    ...
    new Level("dote", 45.73, 7, "Silver", "143433221", "Small Skips", ["zis08"], "Taublix", "https://www.youtube.com/embed/E2WRUJ1K5cY", [
        ...
        new Record("tFluffy", "64", "4/10", "high bronze to low silver", "https://youtu.be/K5uwTRWt1Vs"),
    ], "/nongs/dote.mp3"),
    ...
    new Level("with a bagfullofgold", 43.5, 17, "Silver", "143689393", "Small Skips", ["windboss07"], "EndGamer7896", "https://medal.tv/games/geometry-dash/clip/n9HpJsNwPWOFsQzJW?invite=cr-MSxyVmksNTk1MDYwNDc2", [
    ...
    new Level("Joy and rainbows", 40.9, 4, "Silver", "141413356", "Small Skips", ["Sp4c3m0nk3y"], "Komically", "https://youtube.com/embed/338pvY8as70", [
        ...
        new Record("tFluffy", "74", "1/10", "N/A", "https://youtu.be/OGXbKyrjIuM"),
    ], false),
    ...
    */
    ...
    new Level("Blank", 21.51, 14, "Bronze", "148388579", "Small Skips", ["Taublix"], "tFluffy", "https://youtube.com/embed/liMHS1Huxik", [
    ...
    new Level("TReasons Politics", 5.37, 1, "Bronze", "143564720", "Any Route", ["xpfinker812"], "Taublix", "https://www.youtube.com/embed/oZnGKNtZV_M", [
        ...
        new Record("tFluffy", "13", "2/10", "placement's prob fine", "https://youtu.be/ztt1nc7L_7s"),
    ], false),
...
let displacement = [
    ...
    */
    ...
    new Level("surge", 0, 15, "Limbo", "143281751", "Any Route", ["placek3"], "-", "https://www.youtube.com/embed/dQw4w9WgXcQ", [], false),
    new Level("the demise of zis", 0, 25, "Limbo", "145660505", "Small Skips", ["windboss07"], "-", "https://www.youtube.com/embed/5DO_tL9MoiY", [], false),
    ...
    new Level("FINAL ROBOTISY", 0, 8, "Limbo", "141287742", "Small Skips", ["XanderGMDD"], "-", "https://youtube.com/embed/T1hh2CH1XiQ", [], false),
    ...
    new Level("The Third Robot", 0, 5, "Limbo", "136718958", "Any Route", ["Zannoz"], "-", "https://youtube.com/embed/ggxPP26rFWA", [], false),
    new Level("Wear House", 0, 21, "Limbo", "144301139", "Small Skips", ["zis08"], "-", "https://youtube.com/embed/Sw-tf05DSek", [], "/nongs/Wear House.mp3"),
    new Level("flaming cavern", 0, 11, "Limbo", "144036531", "Any Route", ["windboss07"], "-", "https://youtube.com/embed/5RtA_BHUizw", [], false),
    ...
    new Level("Killbot", 0, 16, "Limbo", "146039806", "Showcase Route", ["XanderGMDD"], "-", "https://youtube.com/embed/W4mnR9ADnf8", [], "/nongs/Killbot, Killbot Minus.mp3"),
    new Level("LightMost", 0, 10, "Limbo", "142864406", "Small Skips", ["Seedskyy73"], "-", "https://www.youtube.com/embed/nPLAKTG72dI", [], "/nongs/LightMost.mp3"),
